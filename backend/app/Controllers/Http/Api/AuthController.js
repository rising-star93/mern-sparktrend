...
class AuthController extends BaseController {
  ...
  async register ({ request, response }) {
    let userData = request.only(['name', 'email', 'password', 'locale', 'country', 'gender', 'paypal_email'])
    userData.email = punycode.toUnicode(userData.email)
    if (userData.paypal_email) {
      userData.paypal_email = punycode.toUnicode(userData.paypal_email)
    }
